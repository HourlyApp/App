  ...
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <header className="flex flex-col items-center justify-center w-full gap-2">
        <nav className ="w-full h-20 flex ml-80 justify-start">

          <div className="Home text-black text-center pt-3 font-bold ml-50 text-2xl w-30 h-15 rounded-3xl  bg-white">
            Home

          </div>

            <div className="Home text-black text-center pt-3 font-bold ml-20 text-2xl w-60 h-15 rounded-3xl  bg-white">
            Leaderboard
       ...
       {/* <PillNav
          items={[
            ...
            { label: 'Log In', href: './login', () => signIn("google") },
          ]}
          activeHref="/"
      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center w-full">
        ...
        <button className="bg-sky-500 hover:bg-sky-700 rounded-full w-25 h-9 flex items-center justify-center">
          ...
          <label for="activity" class="block text-sm/6 font-medium text-white">Activity</label>
          <div class="mt-2">
